...
class PostsTestCase(APITestCase):
    ...
    def test_get(self):
        ...
        test_post_6 = Post.objects.create(title='TestPost6', author= test_user_3, content='Some test 6 content')
        test_post_7 = Post.objects.create(title='TestPost7', author= test_user_1, content='Some test 7 content')
        test_post_8 = Post.objects.create(title='TestPost8', author= test_user_2, content='Some test 8 content')
        test_post_9 = Post.objects.create(title='TestPost9', author= test_user_3, content='Some test 9 content')
